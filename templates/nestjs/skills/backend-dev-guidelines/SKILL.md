...
### 5. Strict Logging Standards

```typescript
// ❌ NEVER: Instantiate Logger
const logger = new Logger();

// ✅ ALWAYS: Use safe static Logger with Context
Logger.log("Order processed", "OrderService");
```
...
❌ No input validation
❌ Direct Prisma everywhere
❌ console.log OR new Logger() instantiation
