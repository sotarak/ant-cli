...
python .agent/skills/design-system/scripts/search-slides.py "metrics dashboard" -d layout

# Contextual recommendation
python .agent/skills/design-system/scripts/search-slides.py "traction slide" \
