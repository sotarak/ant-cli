...
```bash
node .agent/skills/brand/scripts/inject-brand-context.cjs
node .agent/skills/brand/scripts/validate-asset.cjs <path>
```

**Tokens:**

```bash
node .agent/skills/design-system/scripts/generate-tokens.cjs -c tokens.json
node .agent/skills/design-system/scripts/validate-tokens.cjs -d src/
```
